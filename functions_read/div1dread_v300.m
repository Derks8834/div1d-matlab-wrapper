function  [output,input] = div1dread_v300(path)
% div1dread_v300(path) reads the output div1doutput.txt specified in path
...
cell  = textscan(fid, '   impurity_concentration  = %f','delimiter','\n'); input.impurity_concentration = cell2mat(cell(1));
cell  = textscan(fid, '   impurity_Z              = %f','delimiter','\n'); input.impurity_Z = cell2mat(cell(1));
...
for itime = 1: Ntime
    ...
    cell = textscan(fid,'dyn_imp_con = %f','delimiter','\n'); dyn_imp_con(itime) = cell2mat(cell(1));
