function  [output,input] = div1dread_v302(path)
% div1dread_v302(path) reads the output div1doutput.txt specified in path
...
input.gas_puf_prf = zeros(Nx,1);
 % read the information line and skip
    ...
    input.flx_exp_prf = cell2mat(profile_inputs(:,3)); %the same as B_field, (legacy)
