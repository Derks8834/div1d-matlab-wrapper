...
sol2divfluxo = input.flux_i_sol2divo;
sol2divfluxi = input.flux_i_sol2divi;
...
disp('failed to get the core fluxes')
end
...
fprintf( '\\verb|fl_exp|')
fprintf('& %1.2f ',expansion_fluxo)
fprintf('& [-] \\\\ \n')
fprintf( '\\verb|tr_exp|')
fprintf('& %1.2f ',expansion_transo)
fprintf('& [-] \\\\ \n')
